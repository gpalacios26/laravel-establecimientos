...
@section('content')
    <div class="container">
        ...
        <div class="mt-5 row justify-content-center">
            <form class="col-md-9 col-xs-12 card card-body" method="POST" action="{{ route('establecimiento.store') }}"
                ...
                <fieldset class="border p-4">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select id="categoria" class="form-control @error('categoria_id') is-invalid @enderror"
                            name="categoria_id">
                ...
                <fieldset class="border p-4 mt-5">
                    ...
                    <p class="informacion">Confirma que la dirección es correcta</p>

                    <div class="form-group">
                        <label for="direccion">Dirección</label>

                        <input id="direccion" type="text" class="form-control @error('direccion') is-invalid @enderror"
                            placeholder="Dirección" value="{{ old('direccion') }}" name="direccion" readonly>
